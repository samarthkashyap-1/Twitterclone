...
function Sidebar ({userdata,handlelogout}){
    return (
      <div className="flex flex-col ml-10 gap-y-0.5 justify-start h-screen bg-black border-r-[1px] border-gray-700">
        {/* logout dailog  */}
          ...
          >
            <div className="text-white hover:bg-gray-900 cursor-not-allowed rounded-lg">
              <button
                ...
                className=" mx-2 cursor-not-allowed text-sm h-10  my-auto"
              >
                Add an exsisting account
              </button>
            </div>
            <div className="hover:bg-gray-900 text-white rounded-lg">
              <button onClick={handlelogout} className=" mx-2 h-10 text-sm my-auto ">
        ...
        <div className="mt-24  transition-all">
          <button
